...
namespace NORCE.Drilling.GravitationalField.PseudoConstructorsWriter
    {
    class Writer
    {     
        private static readonly string NAMESPACE = "NORCE.Drilling.GravitationalField.ModelShared";    
        ...
        public static bool ChangeICollectionToList(DirectoryInfo directory)
        {
            ...
            {                
                ...
                string filePath = fullPath + "GravitationalFieldMergedModel.cs";
